    ...
    <Image src={portfolio_img} className="img-fluid" roundedCircle />
            ...
            <Col md={6}>
                <Card className="h-100 border-0">
                    ...
                    <p className="lead">I am anxious to start working on new projects once my bootcamp ends..  I want to design and develop custom websites using the latest technologies that I have been learning, such as HTML5, CSS, JavaScript, React.js, jQuery, Bootstrap, APIs, AJAX, MySQL, MongoDB, Node.js, Express.js, Heroku, and GitHub.   </p>
                    <p className="lead">
                        My dream job is to work for a company that values innovation and worklife balance. And I will add value to that company by bringing my strong collaboration skills and expertise that I have acquired throughout my work history. 
                    </p>
                    </Card.Body>
                </Card>
            </Col>
